<?php
/* ----------------------------------------------------------------------
   $Id: syncinclude.php,v 1.7 2006/07/09 03:18:58 r23 Exp $
...
function getFremdEigenschaftsWert($eS_key)
{
	...
	$cur_query = xtc_db_query("SELECT products_attributes_id
                                   FROM eazysales_mvariationswert
